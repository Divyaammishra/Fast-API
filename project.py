...
class UserInput(BaseModel):
    ...
    income_lpa: Annotated[float, Field(..., gt=0, description='Annual income of the person')]
    smoker: Annotated[bool, Field(..., description='If the person smoker')]
    city: Annotated[str, Field(..., description='name of the city person belongs to')]    
